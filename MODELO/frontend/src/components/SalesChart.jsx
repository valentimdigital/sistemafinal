...
// Importe dddInfo e extrairDDD do local correto se necessário
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:3001/api/contatos')
      ...
      .then(contatos => {
        ...
        // Aqui você pode adaptar para usar a função utilitária do seu frontend
        const dddMap = {};
        contatos.forEach(c => {
          const ddd = c.numero ? c.numero.substring(0, 2) : '--';
